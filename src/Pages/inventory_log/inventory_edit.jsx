            ...
            <div className='flex inter'>
                ...
                <div className="w-full width__right relative max-md:ms-0">
                    ...
                    <div className="flex justify-between gap-[10px] mb-[50px] flex-wrap max-sm:mb-[20px]" >
                        <h4 className="text-[18px] text-gray font-semibold">Warehouse Add</h4>
                    </div>
                        ...
                        <div className=''>
                            <div className='bg-white shadow-[0px_3px_4px_rgba(0,0,0,0.1)] rounded-[0.75rem]  mb-[30px]'>
                                <div className='px-[24px] py-[18px] border-b border-[#eaedf1]'>
                                    <h3 className='text-[#313b5e] font-[600]'>Warehouse Information</h3>
                                </div>
                                ...
                                <div className='px-[24px] py-[18px] flex justify-end border-t border-[#eaedf1]'>
                                    <button onClick={handleSubmit} className="bg-primary text-white rounded-[0.75rem] text-[14px]  h-[40px] px-[16px] py-[8px]">Update warehouse</button>
                                </div>
