...
import ProductVariants from '../../Componenet/variants/variants';
...
const Edit_product = () => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            safeAppend("gst_percentage", form.gst_percentage);
                        ...
                        <div className="w-[100%] max-2xl:w-[60%] max-lg:w-[100%]  rounded-xl  max-lg:mt-[24px]">
                            ...
                            <div className="mb-[24px]     bg-white shadow-md rounded-[12px]">
                                ...
                                <div className="px-[24px] py-[18px] max-sm:p-[10px]  max-lg:px-[18px] ">
                                    ...
                                    <div className="grid grid-cols-4 max-lg:grid-cols-2  gap-5 max-xl:gap-2 max-lg:gap-5 max-sm:block">
                            ...
                            <div className="mb-[24px]       bg-white shadow-md rounded-[12px]">
                                ...
                                <div className="px-[24px] py-[18px] max-sm:p-[10px] max-lg:px-[18px] ">
                                    <div className="grid grid-cols-3 gap-5 max-sm:block max-lg:grid-cols-2 mb-4">
                                        ...
                                        {/* gst_percentage */}
                                        <div className="max-sm:mb-4">
                                            <label className="block text-sm mb-1 font-medium text-gray">gst_percentage</label>
