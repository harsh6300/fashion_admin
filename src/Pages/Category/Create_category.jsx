                    ...
                    <div className="flex gap-8 max-lg:block">
                        ...
                        <div className="w-[25%] max-2xl:w-[40%] max-lg:w-[100%]     ">
                            <div className="  p-[20px] max-sm:p-[10px] rounded-xl bg-white shadow-[0_4px_24px_2px_rgba(20,25,38,0.05)]">
                                <div
                                    className="flex justify-center items-center bg-[#eef2f7] h-[360px] rounded-[12px] cursor-pointer"
                                    onClick={() => {
                                        if (images.length === 0) {
                                ...
                                <div className="mt-5">
                                    <h4 className="hans font-[600] text-[25px] text-[#313b5e] mb-[18px] max-sm:text-[16px] max-sm:mb-[12px]">{form.categoryName}</h4>
