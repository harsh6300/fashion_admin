...
import { useAddBillMutation, useGetCategoriesQuery, useGetCustomersQuery } from "../../services/apiSlice";
...
const Create_bill = () => {
    ...
    const handlesubmit = async () => {
        ...
        try {
            ...
            const response = await addBill(formData).unwrap();
                        ...
                        <div className="w-[100%] max-2xl:w-[60%] max-lg:w-[100%]  rounded-xl  max-lg:mt-[24px]">
                            ...
                            <div className="mb-[24px]     bg-white shadow-md rounded-[12px]">
                                ...
                                <div className="px-[24px] py-[18px] max-sm:p-[10px]  max-lg:px-[18px] ">
                                    ...
                                    <BillingForm productitem={handleChildChange}/>
