...
import { useAddColorMutation, useAddFebricMutation } from '../../services/apiSlice';

const Create_febric = () => {
    const [isOpen, setIsOpen] = useState(false);
    const [isOpenside, setIsOpenside] = useState(false);
    const [colorName, setColorName] = useState('');
    const [userStatus, setUserStatus] = useState('Active'); // or 'Inactive'
    const [addColor] = useAddFebricMutation(); // Assuming you have a mutation for adding color
    ...
    const handlesubmit = async () => {
        try {
            ...
            toast.success("Fabric successfully add!");
        ...
        <div>
            ...
            <div className='flex inter'>
                ...
                <div className="w-full width__right relative max-md:ms-0">
                    <SubHeader setIsOpenside={setIsOpenside} pageName={"Fabric Add"} />
                    <div className="flex justify-between gap-[10px] mb-[50px] flex-wrap max-sm:mb-[20px]" >
                        <h4 className="text-[18px] text-gray font-semibold">Fabric Add</h4>
                    </div>
